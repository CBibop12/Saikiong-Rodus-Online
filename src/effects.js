...
export function addEffect(character, effectObj) {
    ...
    character.effects.push({...effectObj, effectId: generateId()});
    return effectObj;
}
...
export function removeEffect(character, effectId) {
  ...
  if (character.effects[effectIndex].consequence) {
    character.effects[effectIndex].consequence(character, character.effects[effectIndex].initialDamage ? character.effects[effectIndex].initialDamage : null);
  }
